...
1. Create a Ko-fi product/shop item at €8.99.
...
1. **App Store build (strongest).** Apple's receipt + DRM makes it effectively unpirateable for normal
   users, and it is the $9.99 tier. Push mainstream users here.
...
- Pricing is as you asked (**$9.99 App Store, €8.99 direct**). Pricing the store higher than direct is the
